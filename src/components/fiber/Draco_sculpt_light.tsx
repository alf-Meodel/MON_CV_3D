...
Command: npx gltfjsx@6.5.2 public/models/draco_sculpt_light.glb 
*/
...
export function LightModel(props: ModelProps) {
  const { nodes } = useGLTF('/models/draco_sculpt_light.glb') as GLTFTypes
...
useGLTF.preload('/models/draco_sculpt_light.glb')
